...
export async function initialize({admin, decimal, name, symbol}: {admin: Address, decimal: u32, name: Buffer, symbol: Buffer}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'initialize', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(admin), ((i) =>xdr.ScVal.scvU32(i))(decimal), ((i) =>xdr.ScVal.scvBytes(i))(name), ((i) =>xdr.ScVal.scvBytes(i))(symbol)]};
...
export async function incr_allow({from, spender, amount}: {from: Address, spender: Address, amount: i128}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'incr_allow', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(from), ((i) =>SorobanClient.Address.fromString(i).toScVal())(spender), ((i) =>xdr.ScVal.scvI128(xdr.Int128Parts.fromXDR(i.toString(16), 'hex')))(amount)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
...
export async function decr_allow({from, spender, amount}: {from: Address, spender: Address, amount: i128}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'decr_allow', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(from), ((i) =>SorobanClient.Address.fromString(i).toScVal())(spender), ((i) =>xdr.ScVal.scvI128(xdr.Int128Parts.fromXDR(i.toString(16), 'hex')))(amount)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
...
export async function xfer({from, to, amount}: {from: Address, to: Address, amount: i128}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'xfer', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(from), ((i) =>SorobanClient.Address.fromString(i).toScVal())(to), ((i) =>xdr.ScVal.scvI128(xdr.Int128Parts.fromXDR(i.toString(16), 'hex')))(amount)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
...
export async function xfer_from({spender, from, to, amount}: {spender: Address, from: Address, to: Address, amount: i128}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'xfer_from', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(spender), ((i) =>SorobanClient.Address.fromString(i).toScVal())(from), ((i) =>SorobanClient.Address.fromString(i).toScVal())(to), ((i) =>xdr.ScVal.scvI128(xdr.Int128Parts.fromXDR(i.toString(16), 'hex')))(amount)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
...
export async function burn({from, amount}: {from: Address, amount: i128}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'burn', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(from), ((i) =>xdr.ScVal.scvI128(xdr.Int128Parts.fromXDR(i.toString(16), 'hex')))(amount)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
...
export async function burn_from({spender, from, amount}: {spender: Address, from: Address, amount: i128}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'burn_from', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(spender), ((i) =>SorobanClient.Address.fromString(i).toScVal())(from), ((i) =>xdr.ScVal.scvI128(xdr.Int128Parts.fromXDR(i.toString(16), 'hex')))(amount)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
...
export async function clawback({admin, from, amount}: {admin: Address, from: Address, amount: i128}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'clawback', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(admin), ((i) =>SorobanClient.Address.fromString(i).toScVal())(from), ((i) =>xdr.ScVal.scvI128(xdr.Int128Parts.fromXDR(i.toString(16), 'hex')))(amount)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
...
export async function set_auth({admin, id, authorize}: {admin: Address, id: Address, authorize: boolean}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'set_auth', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(admin), ((i) =>SorobanClient.Address.fromString(i).toScVal())(id), ((i) =>xdr.ScVal.scvBool(i))(authorize)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
...
export async function mint({admin, to, amount}: {admin: Address, to: Address, amount: i128}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'mint', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(admin), ((i) =>SorobanClient.Address.fromString(i).toScVal())(to), ((i) =>xdr.ScVal.scvI128(xdr.Int128Parts.fromXDR(i.toString(16), 'hex')))(amount)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
...
export async function set_admin({admin, new_admin}: {admin: Address, new_admin: Address}) {
    let invokeArgs: InvokeArgs = {"sign": true, method: 'set_admin', args: [((i) =>SorobanClient.Address.fromString(i).toScVal())(admin), ((i) =>SorobanClient.Address.fromString(i).toScVal())(new_admin)]};
    // @ts-ignore Type does exist
    const response = await invoke(invokeArgs);
